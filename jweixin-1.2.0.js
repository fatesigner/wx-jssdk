!function (a, b) {
  ...
  function h(a, b, c) {
    ...
    var e = d.indexOf(':'); var f = d.substring(e + 1);
    switch (f) {
      case'ok':
  ...
  if (!a.jWeixin) {
    var p = {
        ...
        return a;
      }(); var r = a.document; var s = r.title; var t = navigator.userAgent.toLowerCase(); var u = navigator.platform.toLowerCase();
      var v = !(!u.match('mac') && !u.match('win')); var w = t.indexOf('wxdebugger') != -1;
      var x = t.indexOf('micromessenger') != -1; var y = t.indexOf('android') != -1;
      var z = t.indexOf('iphone') != -1 || t.indexOf('ipad') != -1; var A = function () {
        var a = t.match(/micromessenger\/(\d+\.\d+\.\d+)/) || t.match(/micromessenger\/(\d+\.\d+)/);
        return a ? a[1] : '';
      }(); var B = { initStartTime: m(), initEndTime: 0, preVerifyStartTime: 0, preVerifyEndTime: 0 }; var C = {
        version: 1,
        appId: '',
        initTime: 0,
        preVerifyTime: 0,
      ...
      }; var D = {}; var E = { _completes: [] }; var F = { state: 0, data: {} };
    n(function () {
      B.initEndTime = m();
    });
    var G = !1; var H = []; var I = {
      config: function (a) {
        ...
        var b = function (a) {
          ...
          if (delete a.subtype, c) a.networkType = c; else {
            var d = b.indexOf(':'); var e = b.substring(d + 1);
            switch (e) {
              case'wifi':
              case'edge':
              case'wwan':
        ...
        for (var b = a.cardList, d = [], e = 0, f = b.length; f > e; ++e) {
          var g = b[e]; var h = { card_id: g.cardId, card_ext: g.cardExt };
          d.push(h);
        }
        ...
        for (var b = a.cardList, d = [], e = 0, f = b.length; f > e; ++e) {
          var g = b[e]; var h = { card_id: g.cardId, code: g.code };
          d.push(h);
        }
    ...
    return r.addEventListener('error', function (a) {
      if (!y) {
        var b = a.target; var c = b.tagName; var d = b.src;
        if (c == 'IMG' || c == 'VIDEO' || c == 'AUDIO' || c == 'SOURCE') {
          var e = d.indexOf('wxlocalresource://') != -1;
          if (e) {
      ...
      if (!y) {
        var b = a.target; var c = b.tagName;
        b.src;
        if (c == 'IMG' || c == 'VIDEO' || c == 'AUDIO' || c == 'SOURCE') {
          var d = b['wx-id'];
          d && (K[d] = !1);
